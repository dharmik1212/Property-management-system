...
<body>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" class="form-control" name="price_max" id="price_max" 
                                 ...
                                 <input type="date" class="form-control" name="date_from" id="date_from" 
                                        value="<?php echo $date_from; ?>" placeholder="yyyy-mm-dd">
                             </div>
                             <div class="col-md-2">
                                 <label for="date_to" class="form-label">Date To</label>
                                 <input type="date" class="form-control" name="date_to" id="date_to" 
                                        value="<?php echo $date_to; ?>" placeholder="yyyy-mm-dd">
                             </div>
                            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">
                            <i class="fas fa-list me-2"></i>Property Details
                        </h5>
                    </div>
                    <div class="card-body">
                             ...
                             <table class="table table-hover table-striped">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-secondary"><?php echo ucfirst($property['property_type']); ?></span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                ...
                                                <button type="button" class="btn btn-outline-info" title="View Details"
                                                        onclick="showPropertyDetails(<?php echo $property['id']; ?>)">
    ...
    <script>
        function showPropertyDetails(propertyId) {
            // For now, just show a simple alert with the property ID
            // In a real implementation, you would fetch the property details via AJAX
            alert('Property ID: ' + propertyId + ' - Details would be loaded here');
        }
    </script>
</body>
</html>
